...
| defendDate `required`     | Int        | The end date and time of a defend campaign. This value is only referenced when `campaignType = 2` and uses the epoch time value. As such, must be formatted in Epoch. |
